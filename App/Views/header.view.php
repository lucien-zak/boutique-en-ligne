<header>
    <nav>
        ...
        <a <?= $params['titre'] == "Accueil" ? "class='color-orange'" : "";?> href="/products"><i class="color fas fa-record-vinyl"></i></a>
        <a <?= $params['titre'] == "Accueil" ? "class='color-orange'" : "";?> href="/cart"><i class="color fas fa-shopping-cart"></i></a>

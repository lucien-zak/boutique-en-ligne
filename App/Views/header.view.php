...
<header>
    <nav>
        ...
        <a <?= $params['titre'] == "Votre Panier" ? "class='color-orange'" : "";?> href="/account/cart"><?= App\Controllers\CartController::count_product_cart().' articles ' .App\Controllers\CartController::total_product_cart().' $' ?><i class="color fas fa-shopping-cart"></i></a>
